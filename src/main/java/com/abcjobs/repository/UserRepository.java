...
public interface UserRepository extends JpaRepository<User, Long>{
    ...
    void updateProfil(@Param("user_id") Long id, @Param("name") String name, @Param("email") String email, @Param("address") String address, @Param("age") String age, @Param("username") String username);
