...
<img src="https://cdn-icons-png.flaticon.com/512/149/149071.png?w=740&t=st=1677029695~exp=1677030295~hmac=a07d5e487bc758003444fea64f64f67077e88d0aa2c4b0ed0ae25dc46b5509dd"
            	alt="Generic placeholder image" class="img-fluid img-thumbnail mt-4 mb-2" style="width: 150px; z-index: 1">                    <button id="follow" type="button" class="btn btn-outline-dark" data-mdb-ripple-color="dark"
                ...
                <div class="p-4 text-black" style="background-color: #eeeeee;">
                  <div class="d-flex justify-content-end text-center py-1">
                    <div>
                       <a href="update" class="btn btn-dark">Edit Profile</a>
                    </div>
                  </div>
                  </div>
