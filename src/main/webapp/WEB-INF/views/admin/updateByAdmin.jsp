...
<div class="mb-3 p-3 shadow">
	<div class="d-flex">
    	<h3>Information</h3>
        	<button type="button" class="btn btn-dark ms-auto" data-bs-toggle="modal" data-bs-target="#information"> Add Information</button>
    		...
    		<div class="modal-dialog">
	    		<div class="modal-content">
	                ...
	                <div class="modal-footer">
	               		<button type="submit" class="btn btn-dark" data-bs-dismiss="modal" id="exBtn">Confirm</button>
	                </div>
	           	</div>
	       	</div>
...
<div class="mb-3 p-3 shadow">
	<div class="d-flex">
    	<h3>Experience</h3>
       	<button type="button" class="btn btn-light ms-auto" data-bs-toggle="modal" data-bs-target="#experiences"> </button>
    <div class="modal fade" id="experiences" tabindex="-1" aria-labelledby="experiencesLabel" aria-hidden="true">
    	<div class="modal-dialog">
    		<div class="modal-content">
                ...
                <div class="modal-footer">
               		<button type="button" class="btn btn-dark" data-bs-dismiss="modal" id="exBtn">Add</button>
                </div>
           	</div>
       	</div>
    	</div>
...
<div class="mb-3 p-3 shadow">
	<div class="d-flex">
    	<h3>Education</h3>
        	<button type="button" class="btn btn-light ms-auto" data-bs-toggle="modal" data-bs-target="#education"> </button>
